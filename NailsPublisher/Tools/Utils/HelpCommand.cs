...
public static class HelpCommand
{
    public static async Task HelpCommandAsync(ITelegramBotClient botClient, Message msg)
    {
        var helpText = "<b>📚 Справка по командам бота для мастера маникюра</b>\n\n" +
                       ...
                       "<code>/profit ДНЕЙ</code> - показать статистику прибыли за последние ДНЕЙ дней (0 для всего времени)\n" +
                       "<blockquote>Пример: <code>/profit 30</code></blockquote>\n" +
                       "<code>/expenses</code> - показать статистику расходов\n" +
                       "<code>/products</code> - показать аналитику товаров, включая расчет времени для покупки некупленных товаров\n" +
                       "<code>/orders</code> - показать статистику по заказам, включая доходы за разные периоды\n" +
                       "<code>/summary</code> - показать общую сводку с подробной информацией о финансах, активности, товарах и доступности\n\n" +
                       
                       "<b>🔹 Администрирование (только для владельца):</b>\n" +
                       "<code>/makeadmin ID</code> - выдать права администратора пользователю\n" +
